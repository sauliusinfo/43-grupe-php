...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
  ...
  echo '
    ...
    <div class="container">
        <div class="message">
        <h3>Lėšos sėkmingai įskaitytos</h3><br>
        <a href="../index.php">[ X ]</a>
        </div>
    </div>
    </body>
...
<head>
  ...
  <meta http-equiv="X-UA-Compatible" content="IE=edge">
  <meta name="viewport" content="width=device-width, initial-scale=1.0">
  <title>Lėšų įskaitymas</title>
  <link rel="stylesheet" href="../main/w3.css">
  <link rel="stylesheet" href="../main/w3Plus.css">
</head>
<body style="margin-left: 15px;">
  <h3>Lėšų įskaitymas <a href="../index.php">[ X ]</a></h3>

  <form method="POST" action="addAmount.php?cardID=<?php echo $cardID; ?>">
    <input class="w3-input w3-border w3-margin-bottom" type="text" name="amount" id="amount" placeholder="0.00" required>
    <button class="w3-input w3-block w3-button w3-padding-large w3-green" type="submit">Įskaityti lėšas</button>
  </form>
